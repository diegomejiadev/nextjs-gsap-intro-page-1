...
const HomePage: NextPage = () => {
  ...
  useEffect(() => {
    ...
    .to(titleRef.current, { opacity: "0", duration: .1 })
    .to(titleRef.current, { translateY: "110%", duration: .1 })
        ...
        <div className={styles.tiger}>
          ...
          <div>
            <p>
              ...
              contrasted. Fortune day out married parties. Happiness remainder
              joy but earnestly for off. Took sold add play may none him few. If
              as increasing contrasted entreaties be. Now summer who day looked
              our behind moment coming. Pain son rose more park way that. An
              stairs as be lovers uneasy.
            </p>
          </div>
        </div>
